            ...
            <table class="table table-hover">
                ...
                <c:forEach items="${authors}" var="author">
                    <tr>
                        ...
                        <td>
                            <a href="${pageContext.request.contextPath}/provectusTestTask/author/admin/edit/${author.id}">Edit</a>
                        </td>
                    </tr>
                </c:forEach>
                <tr>
                    <td></td>
                    <td></td>
                    <td><a href="${pageContext.request.contextPath}/provectusTestTask/author/admin/new">Add new
                        author</a></td>
                </tr>
                </tbody>
            </table>
