...
<div class="container">
    <div class="row">
        <div class="col-md-6">
            <div class="about-text">
                <div class="section-title">
                    <h4></h4>
                    <h2>Add new <strong>Author</strong></h2>
                    <hr>
                    <div class="clearfix"></div>
                </div>
                <div class="about-list">

                    <form action="${pageContext.request.contextPath}/provectusTestTask/genre/admin" method="post">
                        <div class="row">
        ...
        <div class="col-md-6">
            <img src="/resources/img/openedBookGenre.jpg" class="img-responsive">
        </div>
    </div>
</div>
