...
<div class="container">
    <div class="row">
        <div class="col-md-6">
            <div class="about-text">
                <div class="section-title">
                    <h4></h4>
                    <h2>Edit <strong>Genre</strong></h2>
                    <hr>
                    <div class="clearfix"></div>
                </div>
                <div class="about-list">
                    <form action="${pageContext.request.contextPath}/provectusTestTask/genre/admin/edit" method="post">
        ...
        <div class="col-md-6">
            <img src="/resources/img/homeLibrary.jpg" class="img-responsive">
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="about-text">
                <ul class="about-list">
                    <strong>Books of this Genre</strong>
                    <c:forEach items="${genre.books}" var="book">
                        <li>
                            <span class="fa fa-dot-circle-o"></span>
                            <strong>${book.name}</strong> <a
                                href="${pageContext.request.contextPath}/provectusTestTask/genre/admin/removeBook/${book.id}/${genre.id}">Remove
                            from this genre</a>
                        </li>
                    </c:forEach>
                </ul>
        ...
        <div class="col-md-6">
            <div class="about-text">
                <div class="about-list">
                    <strong>Add Books to this Genre</strong>
                    <form action="${pageContext.request.contextPath}/provectusTestTask/genre/admin/addBook/${genre.id}"
                          method="get">
