...
<div class="container center">
    <div class="row">
        <div class="books-info">
            <h2><strong>Choose and Edit</strong></h2>
            <div class="line"></div>
            <table class="table table-hover">
                ...
                <c:forEach items="${genres}" var="genre">
                    <tr>
                        ...
                        <td><a href="${pageContext.request.contextPath}/provectusTestTask/genre/admin/edit/${genre.id}">Edit</a></td>
                    </tr>
                </c:forEach>
                <tr><td></td><td><a href="${pageContext.request.contextPath}/provectusTestTask/genre/admin/new">Add new genre</a></td></tr>
                </tbody>
            </table>
        </div>
    </div>
